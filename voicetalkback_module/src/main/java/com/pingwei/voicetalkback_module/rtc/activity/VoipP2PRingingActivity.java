...
import com.pingwei.common_library.utils.DensityUtil;
...
import com.pingwei.voicetalkback_module.utils.ColorUtils;
import com.pingwei.voicetalkback_module.view.CircularCoverView;
...
public class VoipP2PRingingActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int cint = (int) DensityUtil.dip2px(VoipP2PRingingActivity.this,45);
